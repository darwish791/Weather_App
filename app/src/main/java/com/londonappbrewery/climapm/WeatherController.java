...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "d7ec72092ec971f9eca99d5f47ad7412";
    ...
    LocationManager mLocationManager;  // Start or stop request location update
    ...
    private void letsDoSomeNetworking(RequestParams params) { // params have lat, lon and APP_ID
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(TAG, "onSuccess: JSON is " + response.toString());
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable e, JSONObject response) {
                Log.e(TAG, "onFailure: Fail " + e.toString());
                Log.d(TAG, "onFailure: StatusCodeis " + statusCode);
    ...
    // TODO: Add onPause() here: // free resource, no need to track location every single minute
    @Override
